...
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await databases.listDocuments(db, voteCollection, [
            Query.equal("type", type),                  //attribute i m looking for and type
        ...
        // that means prev vote does not exists or voteStatus changed - so creatin new upvote/downvote doc accordingly
